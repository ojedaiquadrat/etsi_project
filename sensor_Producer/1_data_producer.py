...
"""Shelly Info"""
# Shelly Motion 2 device IP
SHELLY_IP = "10.2.2.3"  # Replace with your sensor's IP
# Shelly API endpoint
...
second_sensor_mac_address = "E1:BE:94:7B:0D:70"  #1_SENSIRIRION
#second_sensor_mac_address = "C4:63:A1:4A:26:18"  #1_SENSIRIRION
...
# Shelly Motion 2 method to get its parameters
def get_motion_status():
    try:
        ...
        return int(motion) #cast from boolean to int

    except requests.exceptions.RequestException as e:
        print(f"Error fetching motion status: {e}")

    except KeyError:
        print("Error: Unable to extract motion data from Shelly's response")
...
async def read_sensor_data(bleSensorClient):
    ...
    try:
        ...
        human_motion = get_motion_status()
        ...
        print(f"Human Motion is:  {human_motion} \n\n")
